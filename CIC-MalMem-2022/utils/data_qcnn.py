...
def get_data(client_id=None, num_clients=DEFAULT_NUM_CLIENTS, alpha=DEFAULT_ALPHA, seed=DEFAULT_SEED, iid=False):
    ...
    label_col = _detect_label_column(train_df, preferred=["Category", "Class", "Label", "Type"])

    if label_col not in test_df.columns:
        test_label_col = _detect_label_column(test_df, preferred=["Category", "Class", "Label", "Type"])
    else:
