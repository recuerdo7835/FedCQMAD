"""
FedCMAD + MLP 瓶颈层 本地训练 - MalDroid-2020
经典非线性特征映射：MLP 瓶颈 (5056->64->ReLU->8)
"""
import torch
import numpy as np
from tqdm import tqdm
import utils.data_qcnn as data_loader
import utils.model_mlp_bottleneck as model_loader
...
if __name__ == "__main__":
    print("CMAD + MLP Bottleneck Training Started...")
